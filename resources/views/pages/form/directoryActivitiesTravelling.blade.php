        ...
        <form class="form-horizontal" method="post" action="{{route('postHotel')}}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nama-tempat" name="nama-tempat" placeholder="Nama Tempat">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="nomor-telephone" name="nomor-telephone" placeholder="Nomor Telephone">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="hari-tidak-operasional" name="hari-tidak-operasional" placeholder="Hari Tidak Operasional">
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-3" for="batasan-usia">Batasan Usia :</label>
                <div class="col-sm-9">
                    <input type="text" class="form-control" id="batasan-usia" name="batasan-usia" placeholder="Batasan Usia">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <label class="radio-inline">
                        <input type="radio" name="area-parkir" id="area-parkir" value="Tersedia">Tersedia
                    </label>
                    <label class="radio-inline">
                        <input type="radio" name="area-parkir" id="area-parkir" value="Tidak Tersedia">Tidak Tersedia
                    </label>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="jenis-tempat" name="jenis-tempat">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <select class="form-control" id="harga-tiket" name="harga-tiket">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <textarea class="form-control" id="deskripsi-tempat" name="deskripsi-tempat" placeholder="Deskripsi Tempat"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-3" for="aktifitas-utama">Aktifitas Utama : </label>
                <div class="col-sm-9">
                    <textarea class="form-control" id="aktifitas-utama" name="aktifitas-utama" placeholder="Aktifitas Utama"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-3" for="fasilitas-pendukung">Fasilitas Pendukung :</label>
                <div class="col-sm-9">
                    <textarea class="form-control" id="fasilitas-pendukung" name="fasilitas-pendukung" placeholder="Fasilitas Pendukung"></textarea>
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-sm-3" for="keterangan-tambahan">Keterangan Tambahan :</label>
                <div class="col-sm-9">
                    <textarea class="form-control" id="keterangan-tambahan" name="keterangan-tambahan" placeholder="Keterangan Tambahan "></textarea>
                </div>
            </div>
